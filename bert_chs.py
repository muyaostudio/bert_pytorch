...
with torch.no_grad():
    ...
    print('\n我和我的祖国 第一个“我”和第三个“我”的相似度：')
    print(cosine_similarity(summed_last_4_layers[1].reshape(1, -1),
                            summed_last_4_layers[3].reshape(1, -1))[0][0])
    print(cosine_similarity(concatenated_last_4_layers[1].reshape(1, -1),
                            concatenated_last_4_layers[3].reshape(1, -1))[0][0])
